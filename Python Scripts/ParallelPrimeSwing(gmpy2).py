#Faster version of Parallel Prime Swing using gmpy2, however, replit and hackerrank don't support gmpy2 :(. Codewars(the website) does however...
...
def factorialPS(n): 
    ...
    return eval(n)
#fast(under 10 second/10000 milliseconds) up to 4 x 10^6